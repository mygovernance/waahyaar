<h1>Welcome to CheerUp!</h1>

<div class="about-text">
	<p>Thank You for installing CheerUp. You're ready to create an amazing site. We hope you will enjoy using the theme. Please read instructions below to get going.</p>
</div>
	...
	<div class="ts-dash-box">
		...
		<?php if (!empty($activated)): ?>
			...
			<p>
				...
				<?php if (!empty($data['email'])): ?>
					...
					Your support login info has been sent to <?php echo esc_html($data['email']); ?>. If you don't receive the email within 5 minutes, please check your Spam folder.
		...
		<?php else: ?>
			...
			<div class="content">
				...
				<p>Note: Click the button below and you will be forwarded to Envato. Login with the account you used to make the purchase and you will return back here.<br /></p>
...
<div class="ts-dash-box">
	...
	<p>Once your theme is activated, our <a href="http://cheerup.theme-sphere.com/documentation/" target="_blank">documentation</a> has all the information you need on getting setup.</p>
	...
	<ol>
		...
		<li>Add a logo, configure your menus, setup your home-page. Learn all these in <a href="http://cheerup.theme-sphere.com/documentation/#post-install" target="_blank">this guide</a>.</li>
	</ol>
</div>
