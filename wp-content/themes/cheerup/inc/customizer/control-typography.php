...
class Bunyad_Customizer_Control_Typography extends WP_Customize_Control
{
	...
	?>
		<label>	
			...
			<div>
				<span class="sub-label"><?php echo esc_html_x('Weight:', 'Admin', 'cheerup'); ?></span>
			...
			<div>
				<span class="sub-label"><?php echo esc_html_x('Size:', 'Admin', 'cheerup'); ?></span>
