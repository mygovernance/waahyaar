...
$classes = array('posts-dynamic posts-container ts-row', $type, 'count-' . $number, $masonry);
$wrap_open = false;
$i = 0;
				...
				<?php if ($type == 'grid'): // Grid post next ?>
					...
					<div class="col-<?php echo (12 / $grid_cols); ?>">	
						<?php 
							Bunyad::core()->partial(
								$grid_template, 
								compact('show_excerpt', 'grid_cols', 'show_footer')
							); 
						?>
					</div>
