...
<div class="sub-menu mega-menu wrap">
		...
		<ol class="sub-nav">
			<?php foreach ($sub_items as $nav_item): ?>
				...
				<?php 
					...
					// Simulate a simpler walk - $output is passed-by-ref
					$output = '';
					$sub_walker->start_el($output, $nav_item);
					$sub_walker->end_el($output, $nav_item);
					
					ob_end_clean();
					
					echo $output; // Safe markup generated via WordPress default Walker_Nav_Menu::start_el()
				?>				
			<?php endforeach; ?>
	...
	<section class="column recent-posts">
		...
		<div class="navigate">
			<a href="#" class="show-prev"><i class="fa fa-angle-left"></i><span class="visuallyhidden"><?php esc_html_e('Previous', 'cheerup'); ?></span></a>
			<a href="#" class="show-next"><i class="fa fa-angle-right"></i><span class="visuallyhidden"><?php esc_html_e('Next', 'cheerup'); ?></span></a>
		</div>
